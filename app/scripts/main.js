...
var clickable = function () {
		...
		var print = function () {
			$('#results').append(
				'<div id="u'+i+'" class="position"><img class="preview" src='+json_a[value].img+' alt="'+json_a[value].name+'" /><h5>'
				+json_a[value].name + '</h5><div class="modal-market"><div><span class="close">X</span>'+
				'<img src='+json_a[value].img+' alt="'+json_a[value].name+'" /><h6>'
                                +json_a[value].name+'</h6><p>'
				+json_a[value].descr +'</p><p id="button" class="hover-board" onclick="orderButton(this);">Заказать</p></div></div></div>');
